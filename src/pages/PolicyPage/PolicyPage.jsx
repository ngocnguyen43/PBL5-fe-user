...
const RegulationsPage = () => {
        ...
        const getItems = (panelStyle) => [
            {
                key: '1',
                label: 'I. Chính sách quyền riêng tư',
                children: [
                { key: '1.1', content: <p style={{ fontWeight: 'normal' }}>{comments[0]}</p> },
                { key: '1.2', content: <p style={{ fontWeight: 'normal' }}>{comments[1]}</p> },
                { key: '1.3', content: <label>1. Mục đích thu thập thông tin của khách hàng</label> },
                { key: '1.4', content: <ul style={{ fontWeight: 'normal' }}><li>{comments[2]}</li></ul> },
                { key: '1.5', content: <label>2. Phạm vi thu thập thông tin của khách hàng</label> },
                { key: '1.6', content: <ul style={{ fontWeight: 'normal' }}><li>{comments[3]}</li></ul> },
                { key: '1.7', content: <label>3. Phạm vi sử dụng thông tin</label> },
                { key: '1.8', content: <p style={{ fontWeight: 'normal' }}>{comments[4]}</p> },
                { key: '1.9', content: <ul style={{ fontWeight: 'normal' }}><li>{comments[5]}</li></ul> },
                { key: '1.10', content: <ul style={{ fontWeight: 'normal' }}><li>{comments[6]}</li></ul> },
                { key: '1.11', content: <ul style={{ fontWeight: 'normal' }}><li>{comments[7]}</li></ul> },
                { key: '1.12', content: <ul style={{ fontWeight: 'normal' }}><li>{comments[8]}</li></ul> },
                { key: '1.13', content: <ul style={{ fontWeight: 'normal' }}><li>{comments[9]}</li></ul> },
                { key: '1.14', content: <label>4. Thời gian lưu trữ thông tin</label> },
                { key: '1.15', content: <ul style={{ fontWeight: 'normal' }}><li>{comments[10]}</li></ul> },
                { key: '1.16', content: <label>5. Những người hoặc tổ chức được tiếp cận với thông tin</label> },
                { key: '1.17', content: <ul style={{ fontWeight: 'normal' }}><li>{comments[11]}</li></ul> },
                { key: '1.18', content: <ul style={{ fontWeight: 'normal' }}><li>{comments[12]}</li></ul> },
                { key: '1.19', content: <ul style={{ fontWeight: 'normal' }}><li>{comments[13]}</li></ul> },
                { key: '1.20', content: <label>6. Đơn vị thu thập thông tin</label> },
                { key: '1.21', content: <ul style={{ fontWeight: 'normal' }}><li>{comments[14]}</li></ul> },
                { key: '1.22', content: <ul style={{ fontWeight: 'normal' }}><li>{comments[15]}</li></ul> },
                { key: '1.23', content: <ul style={{ fontWeight: 'normal' }}><li>{comments[16]}</li></ul> },
                { key: '1.24', content: <ul style={{ fontWeight: 'normal' }}><li>{comments[17]}</li></ul> },
                { key: '1.25', content: <p style={{ fontWeight: 'normal' }}>{comments[18]}</p> },
                { key: '1.26', content: <label>7. Phương tiện và công cụ để người tiêu dùng tiếp cận, chỉnh sửa dữ liệu thông tin cá nhân của mình</label> },
                { key: '1.27', content: <ul style={{ fontWeight: 'normal' }}><li>{comments[19]}</li></ul> },
                { key: '1.28', content: <label>8. Cam kết bảo mật thông tin</label> },
                { key: '1.29', content: <ul style={{ fontWeight: 'normal' }}><li>{comments[20]}</li></ul> },
                { key: '1.30', content: <ul style={{ fontWeight: 'normal' }}><li>{comments[21]}</li></ul> },
                { key: '1.31', content: <ul style={{ fontWeight: 'normal' }}><li>{comments[22]}</li></ul> },
                ],
                style: {
                ...panelStyle,
                fontWeight: 'bold'
            ...
            },
            {
                ...
                children: [
                { key: '2.1', content: <ul style={{ fontWeight: 'normal' }}><li>{comments[23]}</li></ul> },
                { key: '2.2', content: <ul style={{ fontWeight: 'normal' }}><li>{comments[24]}</li></ul> },
                { key: '2.3', content: <ul style={{ fontWeight: 'normal' }}><li>{comments[25]}</li></ul> },
                { key: '2.4', content: <ul style={{ fontWeight: 'normal' }}><li>{comments[26]}</li></ul> },
                ],
                style: {
                ...panelStyle,
                fontWeight: 'bold'
            ...
            },
            {
                ...
                children: [
                { key: '3.1', content: <ul style={{ fontWeight: 'normal' }}><li>{comments[27]}</li></ul> },
                { key: '3.2', content: <ul style={{ fontWeight: 'normal' }}><li>{comments[28]}</li></ul> },
                ],
                style: {
                ...panelStyle,
                fontWeight: 'bold'
