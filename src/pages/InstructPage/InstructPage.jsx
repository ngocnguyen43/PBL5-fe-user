        ...
        const getItems = (panelStyle) => [
            {
                ...
                children: [
                    <ul key="1_1"  style={{ fontWeight: 'normal' }}><li>{comments[0]}</li></ul>,
                    <ul key="1_2" style={{ fontWeight: 'normal' }}><li>{comments[1]}</li></ul>,
                    <ul key="1_3" style={{ fontWeight: 'normal' }}><li>{comments[2]}</li></ul>,
                    <ul key="1_4" style={{ fontWeight: 'normal' }}><li>{comments[3]}</li></ul>,
                    <ul key="1_5" style={{ fontWeight: 'normal' }}><li>{comments[4]}</li></ul>,
                    <ul key="1_6" style={{ fontWeight: 'normal' }}><li>{comments[5]}</li></ul>,
                    <ul key="1_7" style={{ fontWeight: 'normal' }}><li>{comments[6]}</li></ul>,
                ],
                style: {
                    ...panelStyle,
                    fontWeight: 'bold'
            ...
            },
            {
                ...
                children: [
                    <ul key="2_1" style={{ fontWeight: 'normal' }}><li>{comments[7]}</li></ul>,
                    <ul key="2_2" style={{ fontWeight: 'normal' }}><li>{comments[8]}</li></ul>,
                    <ul key="2_3" style={{ fontWeight: 'normal' }}><li>{comments[9]}</li></ul>,
                    <ul key="2_4" style={{ fontWeight: 'normal' }}><li>{comments[10]}</li></ul>,
                    <ul key="2_5" style={{ fontWeight: 'normal' }}><li>{comments[11]}</li></ul>,
                ],
                style: {
                    ...panelStyle,
                    fontWeight: 'bold'
            ...
            },
            {
                ...
                children: [
                    <ul key="3_1" style={{ fontWeight: 'normal' }}><li>{comments[12]}</li></ul>,
                    <ul key="3_2" style={{ fontWeight: 'normal' }}><li>{comments[13]}</li></ul>,
                    <ul key="3_3" style={{ fontWeight: 'normal' }}><li>{comments[14]}</li></ul>,
                    <ul key="3_4" style={{ fontWeight: 'normal' }}><li>{comments[15]}</li></ul>,
                    <ul key="3_5" style={{ fontWeight: 'normal' }}><li>{comments[16]}</li></ul>,
                ],
                style: {
                    ...panelStyle,
                    fontWeight: 'bold'
